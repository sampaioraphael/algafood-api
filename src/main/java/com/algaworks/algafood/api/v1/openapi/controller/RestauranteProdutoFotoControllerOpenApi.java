...
public interface RestauranteProdutoFotoControllerOpenApi {
	...
	@ApiResponses({
		...
		@ApiResponse(code = 404, message = "Produto de restaurante não encotrado", response = Problem.class)
	})
	...
	@ApiResponses({
		...
		@ApiResponse(code = 404, message = "Foto de produtuo não encontrada", response = Problem.class)
	})
